    ...
    <div class="container">
      ...
      <div class="footer">
          ...
          <div class="footer-left">
            ...
            <el-button @click="enterQRcode_Start" class="btn" type="danger" round>扫码骑行</el-button>
            <el-link @click.prevent="enterID_Start" class="ckick-link" :underline="false">无法扫码?点击输入编号</el-link>
          </div>
          
          <!-- 右下角容器 -->
          <div class="footer-right">
            <el-button class="btn" type="info" round>故障上报</el-button>
          </div>
      </div>
      ...
      <el-dialog
        title="请扫描车辆编号二维码开锁"
        :visible.sync="QRcodeScannerVisible"
        top="35vh"
        width="45vh">
      ...
      <!-- 订单计时计费对话框 -->
      <el-dialog title="订单正在进行ing"
      :show-close="false"
      :close-on-press-escape="false"
      :close-on-click-modal="false"
      :modal="true"
      custom-class="time-window"
      top="32vh"
      width="85%"
      center
        ...
        <div class="timeWindow-bodys">
         ...
         <span slot="footer" class="timeWindow-footer">
            ...
            <div v-if="orderState.order_status =='Wait_Pay'">
              ...
              <el-link icon="el-icon-question" :underline="false">该订单已支付?点我申请申诉复查</el-link>
            </div>
         </span>
      </el-dialog>  
    </div>
